    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label for="example-month-input"
                class="col-sm-12 col-lg-3 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.repeat_every')) }}</label>
        ...
        <!--repeat cycle-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.cycles')) }}</label>
            <div class="col-sm-12 col-lg-3">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.next_bill_date')) }}</label>
            <div class="col-sm-12 col-lg-3">
        ...
        <div class="alert alert-info">
            ...
            <h5 class="text-info {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><i class="sl-icon-info"></i> {{ cleanLang(__('lang.first_invoice')) }}</h5>
            <div class="{{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.bill_recurring_cycles_explanation_3')) }}</div>
        </div>
        ...
        <div class="alert alert-info">
            <button type="button" class="invoice-rec-close" data-dismiss="alert" aria-label="Close"> <span
                    aria-hidden="true">×</span> </button>
            <h5 class="text-info {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><i class="sl-icon-info"></i> {{ cleanLang(__('lang.next_bill_date')) }}</h5>
            <div class="{{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.bill_recurring_cycles_explanation_1')) }}</div>
        </div>
