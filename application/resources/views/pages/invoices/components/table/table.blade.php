            ...
            <table id="invoices-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            class="invoices_col_tableconfig_column_1 {{ config('table.tableconfig_column_1') }} tableconfig_column_1 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_2 {{ config('table.tableconfig_column_2') }} tableconfig_column_2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_3 {{ config('table.tableconfig_column_3') }} tableconfig_column_3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_4 {{ config('table.tableconfig_column_4') }} tableconfig_column_4 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_5 {{ config('table.tableconfig_column_5') }} tableconfig_column_5 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_6 {{ config('table.tableconfig_column_6') }} tableconfig_column_6 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_7 {{ config('table.tableconfig_column_7') }} tableconfig_column_7 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_8 {{ config('table.tableconfig_column_8') }} tableconfig_column_8 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_9 {{ config('table.tableconfig_column_9') }} tableconfig_column_9 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_10 {{ config('table.tableconfig_column_10') }} tableconfig_column_10 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_11 {{ config('table.tableconfig_column_11') }} tableconfig_column_11 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_12 {{ config('table.tableconfig_column_12') }} tableconfig_column_12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_13 {{ config('table.tableconfig_column_13') }} tableconfig_column_13 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_14 {{ config('table.tableconfig_column_14') }} tableconfig_column_14 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_15 {{ config('table.tableconfig_column_15') }} tableconfig_column_15 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_16 {{ config('table.tableconfig_column_16') }} tableconfig_column_16 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_amount {{ config('table.tableconfig_column_17') }} tableconfig_column_17 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_19 {{ config('table.tableconfig_column_19') }} tableconfig_column_19 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_payments {{ config('table.tableconfig_column_20') }} tableconfig_column_20 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_21 {{ config('table.tableconfig_column_21') }} tableconfig_column_21 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th
                            class="invoices_col_tableconfig_column_22 {{ config('table.tableconfig_column_22') }} tableconfig_column_22 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                        ...
                        <th class="invoices_col_tableconfig_column_23 {{ config('table.tableconfig_column_23') }} tableconfig_column_23 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><a
                        ...
                        <!--actions-->
                        <th class="invoices_col_action with-table-config-icon {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><a
