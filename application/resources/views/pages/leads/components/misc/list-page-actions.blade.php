...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center {{ app()->getLocale() == 'persian' ? 'text-left' : 'text-right' }}{{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.quick_stats')) }}"
            ...
            data-type="statspanel" data-progress-bar="hidden" data-url-temp="{{ url('/team/updatepreferences') }}"
        ...
        <button type="button" data-toggle="tooltip" title="@lang('lang.export_leads')"
