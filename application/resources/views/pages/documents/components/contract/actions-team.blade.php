    ...
    <div id="list-page-actions">
                    ...
                    <div class="form-group row m-b-10">
                        <div class="col-sm-12">
                            ...
                            <input class="mysql-date" type="hidden" name="publishing_option_date"
                                ...
                                value="{{ $document->doc_publishing_scheduled_date	 ?? '' }}">
                        </div>
                    </div>
                </div>
                <!--form buttons-->
        ...
        <span class="dropdown">
            <button type="button"
                ...
                title="{{ cleanLang(__('lang.clone_contract')) }}" data-toggle="modal" data-target="#commonModal"
                data-modal-title="{{ cleanLang(__('lang.clone_contract')) }}"
                data-url="{{ url('/contracts/'.$document->doc_id.'/clone') }}"
                data-action-url="{{ url('/contracts/'.$document->doc_id.'/clone') }}"
        ...
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_contract')) }}"
            ...
            data-url="{{ url('/contracts/'.$document->doc_id.'?source=page') }}"><i class="sl-icon-trash"></i></button>
        @endif
    </div>
</div>
<!-- action buttons -->