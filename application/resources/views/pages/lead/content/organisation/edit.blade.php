<div class="x-heading {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><i class="mdi mdi-file-document-box"></i>{{ cleanLang(__('lang.organisation')) }}</div>
...
<div class="card-lead-orginisation-edit" id="card-lead-organisation">
    ...
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.company_name')) }}</label>
        <div class="col-sm-12">
    ...
    <!--job title-->
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.job_title')) }}</label>
        <div class="col-sm-12">
    ...
    <!--street-->
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.street')) }}</label>
        <div class="col-sm-12">
    ...
    <!--city-->
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.city')) }}</label>
        <div class="col-sm-12">
    ...
    <!--state-->
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.state')) }}</label>
        <div class="col-sm-12">
    ...
    <!--zip-->
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.zipcode')) }}</label>
        <div class="col-sm-12">
    ...
    <!--country-->
    <div class="form-group row">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.country')) }}
            {{ $lead->lead_country }}</label>
        <div class="col-sm-12">
            @php $selected_country = $lead->lead_country; @endphp
            <select class="select2-basic-with-search form-control form-control-sm" id="lead_country" name="lead_country">
                <option></option>
    ...
    <div class="form-group row" id="card-save-organisation-loading">
        <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.website')) }}</label>
        <div class="col-sm-12">
