<!--heading-->
<div class="x-heading p-t-10 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><i class="mdi mdi-file-document-box"></i>{{ cleanLang(__('lang.organisation')) }}</div>
...
<div class="card-show-form-data " id="card-lead-organisation">
    ...
    <!--company name-->
    <div class="form-data-row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
