            ...
            <div class="r-panel-body">
                    ...
                    <div class="fields">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <option></option>
                                <option value="invoiced">@lang('lang.invoice')</option>
                                <option value="not_invoiced">@lang('lang.not_invoiced')</option>
                            </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="{{ urlResource('/timesheets/search?') }}" data-type="form"
