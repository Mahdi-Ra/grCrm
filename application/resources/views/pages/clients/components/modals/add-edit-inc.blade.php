    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label for="example-month-input"
                class="col-sm-12 col-lg-3 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.status')) }}</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div id="add_client_billing_address_section" class="hidden">
            ...
            <div class="form-group row">
                <label for="example-month-input"
                    class="col-sm-12 col-lg-3 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.country')) }}</label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">{{ cleanLang(__('lang.vat_tax_number')) }}</label>
                <div class="col-sm-12 col-lg-9">
        ...
        <div id="add_client_shipping_address_section" class="hidden">
            ...
            <div class="form-group form-group-checkbox row" id="expense_billable_option">
                <label
                    class="col-sm-12 col-lg-3 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.same_as_billing')) }}</label>
                <div class="col-6 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
        ...
        <div id="client_app_modules_collaped" class="hidden">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.enabled_modules')</label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div id="client_app_modules_pemissions"
                ...
                <div class="highlighted-panel">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.projects')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.invoices')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.payments')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.knowledgebase')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.estimates')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.subscriptions')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="form-group form-group-checkbox row">
                        <label class="col-sm-12 col-lg-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.tickets')</label>
                        <div class="col-sm-12 col-lg-2 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} p-t-5">
                    ...
                    <div class="alert alert-info {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.only_system_enabled_modules_enabled') <a href="{{ url('app/settings/modules') }}" target="_blank">(@lang('lang.see_settings'))</a></div>
                </div>
