...
<div class="form-group row">
    <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">Title</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.description')</label>
    <div class="col-sm-12">
...
<!--assigned users-->
<div class="form-group row">
    <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.automation_assign_project')</label>
    <div class="col-sm-12 ">
...
<div class="modal-selector m-t-50">
    <h5 class="m-t-10 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.dependencies')</h5>

    <!--dependencies - prevent from completing-->
    <div class="form-group row m-t-20">
        <label
            class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.dependency_prevents_task_from_completing')</label>
        <div class="col-sm-12">
    ...
    <div class="form-group row m-t-20">
        <label
            class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.dependency_prevents_task_from_starting')</label>
        <div class="col-sm-12">
