...
<div class="form-group row m-t--30 m-b-45">
    <label class="col-sm-12  col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.title')*</label>
...
<div class="modal-selector p-t-30 p-b-1 m-b-30">
    ...
    <div class="form-group row">
        <label class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.project')*</label>
        <div class="col-sm-12 col-lg-9">
            <select
    ...
    <div class="form-group row">
        <label
            class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.milestone')*</label>
        <div class="col-sm-12 col-lg-9">
    ...
    <!--task status-->
    <div class="form-group row">
        <label class="col-sm-12 col-lg-3 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.status')*</label>
        <div class="col-sm-12 col-lg-9">
...
<div class="hidden" id="toogle_more_information">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.copy_checklists')</label>
    ...
    <!--copy files-->
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">@lang('lang.copy_files')</label>
        <div class="col-2 {{ app()->getLocale() == 'persian' ? 'text-left' : 'text-right' }} p-t-5">
