    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                <i class="ti-export display-inline-block {{ app()->getLocale() == 'persian' ? 'p-l-10' : 'p-r-10' }}"></i>{{ cleanLang(__('lang.export_tasks')) }}
                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30 d-flex" for="standard_field[task_id]">@lang('lang.id')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_title]" name="standard_field[task_title]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_title]">@lang('lang.title')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_date_due]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_date_due]">@lang('lang.due_date')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_assigned]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_assigned]">@lang('lang.assigned')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_priority]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_priority]">@lang('lang.priority')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_status]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_status]">@lang('lang.status')</label>
                            </div>
                        </div>
                    </div>
                    <!--billable-->
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_billable]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_billable]">@lang('lang.billable')</label>
                            </div>
                        </div>
                    </div>
