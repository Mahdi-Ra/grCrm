    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                <i class="ti-export display-inline-block {{ app() -> getLocale() == 'persian' ? 'p-l-10' : 'p-r-10' }}"></i>{{ cleanLang(__('lang.export_projects')) }}
                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30 d-flex" for="standard_field[project_id]">@lang('lang.id')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[project_title]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[project_title]">@lang('lang.title')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[project_status]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[project_status]">@lang('lang.status')</label>
                            </div>
                        </div>
                    </div>
