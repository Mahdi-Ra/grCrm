    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                <i class="ti-export display-inline-block {{ app()->getLocale() == 'persian' ? 'p-l-10' : 'p-r-10' }}"></i>{{ cleanLang(__('lang.export_leads')) }}
                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30 d-flex" for="standard_field[lead_title]">@lang('lang.title')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_email]" name="standard_field[lead_email]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_email]">@lang('lang.email')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_phone]" name="standard_field[lead_phone]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_phone]">@lang('lang.phone')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_website]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_website]">@lang('lang.website')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_street]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_street]">@lang('lang.street')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_city]" name="standard_field[lead_city]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_city]">@lang('lang.city')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_state]" name="standard_field[lead_state]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_state]">@lang('lang.state')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_zip]" name="standard_field[lead_zip]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_zip]">@lang('lang.zipcode')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_country]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_country]">@lang('lang.country')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_value]" name="standard_field[lead_value]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_value]">@lang('lang.value')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_source]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_source]">@lang('lang.source')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[lead_status]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[lead_status]">@lang('lang.status')</label>
                            </div>
                        </div>
                    </div>
