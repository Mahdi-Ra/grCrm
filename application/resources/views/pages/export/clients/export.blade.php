    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                <i class="ti-export display-inline-block {{ app() -> getLocale() == 'persian' ? 'p-l-10' : 'p-r-10' }}"></i>{{ cleanLang(__('lang.export_clients')) }}
                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30 d-flex" for="standard_field[category]">@lang('lang.category')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[client_phone]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[client_phone]">@lang('lang.telephone')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[client_website]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[client_website]">@lang('lang.website')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[invoices]" name="standard_field[invoices]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[invoices]">@lang('lang.invoices')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[payments]" name="standard_field[payments]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[payments]">@lang('lang.payments')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[client_status]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[client_status]">@lang('lang.status')</label>
                            </div>
                        </div>
                    </div>
                </div>
