    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                <i class="ti-export display-inline-block {{ app()->getLocale() == 'persian' ? ' p-l-10' : ' p-r-10' }}"></i>{{ cleanLang(__('lang.export_payments')) }}
                <span>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[payment_date]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[payment_date]">@lang('lang.date')</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30 d-flex" for="standard_field[payment_id]">@lang('lang.payment_id')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[payment_amount]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[payment_amount]">@lang('lang.amount')</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[payment_notes]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[payment_notes]">@lang('lang.notes')</label>
                            </div>
                        </div>
                    </div>
