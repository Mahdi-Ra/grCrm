...
<tr id="template_{{ $template->contract_template_id }}">
    ...
    <!--title-->
    <td class="col_contract_template_title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
    ...
    <td class="col_contract_template_created {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
    ...
    <!--actions-->
    <td class="col_contracts_actions actions_column {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
        <!--action button-->
