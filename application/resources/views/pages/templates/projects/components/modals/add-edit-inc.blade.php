...
<div class="spacer row">
    <div class="col-sm-8 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
        <span class="title">Project {{ cleanLang(__('lang.description')) }}</span>
    </div>
...
<div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-5 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} required">{{ cleanLang(__('lang.task_participation')) }}**</label>
        <div class="col-7 {{ app()->getLocale() == 'persian' ? 'text-left' : 'text-right' }} p-t-5">
    ...
    <div class="form-group form-group-checkbox row">
        <label class="col-5 col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} required">{{ cleanLang(__('lang.create_tasks')) }}**</label>
        <div class="col-7 {{ app()->getLocale() == 'persian' ? 'text-left' : 'text-right' }} p-t-5">
...
<div class="spacer row">
    <div class="col-sm-8 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">
        <span class="title">{{ cleanLang(__('lang.project_billing')) }}</span>
    </div>
    ...
    <div class="highlighted-panel">
        ...
        <div class="form-group row">
            ...
            <div class="collapse col-sm-12 m-t-15" id="project_estimated_hours_info">
                <div class="alert alert-info {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.project_estimated_hours_info')) }}</div>
            </div>
        </div>
        <!--cost estimate-->
        <div class="form-group row m-b-0">
            ...
            <div class="collapse col-sm-12 m-t-15" id="project_cost_estimate_info">
                <div class="alert alert-info {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">{{ cleanLang(__('lang.project_cost_estimate_info')) }}</div>
            </div>
        </div>
    </div>
</div>
