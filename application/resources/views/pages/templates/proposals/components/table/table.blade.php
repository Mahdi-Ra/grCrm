        ...
        <div class="table-responsive">
            ...
            <table id="template-proposal-addrow" class="table m-t-0 m-b-0 table-hover no-wrap" data-page-size="10">
                <thead>
                    ...
                    <th class="col_proposal_template_title {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><a class="js-ajax-ux-request js-list-sorting"
                    ...
                    <th class="col_proposal_template_created {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><a class="js-ajax-ux-request js-list-sorting"
                    ...
                    <!--actions-->
                    <th class="col_proposals_actions w-px-120 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><a href="javascript:void(0)">@lang('lang.actions')</a>
                    </th>
                </thead>
