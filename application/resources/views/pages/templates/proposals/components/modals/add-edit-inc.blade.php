...
<div class="form-group row">
    <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.title')</label>
    <div class="col-sm-12">
...
<div class="form-group row">
    <label class="col-sm-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.content')</label>
    <div class="col-sm-12">
