...
<head>
    ...
    <!-- dompdf font - persian characters-->
    @if(config('system.settings2_dompdf_fonts') == 'persian')
        <style>
            @font-face {
                font-family: 'DynamicFont';
                font-weight: 700;
                font-style: normal;
                src: url('{{ storage_path('application/storage/app/fonts/persian/Vazirmatn-Bold.ttf') }}') format("truetype");
            }
            @font-face {
                font-family: 'DynamicFont';
                font-weight: 300;
                font-style: normal;
                src: url('{{ storage_path('application/storage/app/fonts/persian/Vazirmatn-Light.ttf') }}') format("truetype");
            }
            @font-face {
                font-family: 'DynamicFont';
                font-weight: 400;
                font-style: normal;
                src: url('{{ storage_path('application/storage/app/fonts/persian/Vazirmatn-Regular.ttf') }}') format("truetype");
            }
            @font-face {
                font-family: 'DynamicFont';
                font-weight: 500;
                font-style: normal;
                src: url('{{ storage_path('application/storage/app/fonts/persian/Vazirmatn-Medium.ttf') }}') format("truetype");
            }
            @font-face {
                font-family: 'DynamicFont';
                font-weight: 100;
                font-style: normal;
                src: url('{{ storage_path('application/storage/app/fonts/persian/Vazirmatn-Thin.ttf') }}') format("truetype");
            }
            body, * {
