<div class="invoice-item-actions {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}">

    <!--add blank line-->
    <button type="button" id="billing-item-actions-blank"
        class="btn btn-secondary btn-rounded btn-sm btn-rounded-icon {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><i
    ...
    <button type="button" id="billing-time-actions-blank"
        class="btn btn-secondary btn-rounded btn-sm btn-rounded-icon {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"><i class="mdi mdi-clock text-themecontrast"></i>
    ...
    <!--add product item-->
    <button type="button"
        class="billing-mode-only-item btn btn-secondary btn-rounded btn-sm btn-rounded-icon actions-modal-button js-ajax-ux-request reset-target-modal-form {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"
    ...
    <!--add category items-->
    <button type="button"
        class="billing-mode-only-item btn btn-secondary btn-rounded btn-sm btn-rounded-icon actions-modal-button js-ajax-ux-request reset-target-modal {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }}"
