<div id="invoice-adjustments-popover-content">
    <div class="p-t-10">
        ...
        <div class="form-group row">
            <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.description')</label>
            <div class="col-12">
        ...
        <!--amount-->
        <div class="form-group row">
            <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label">@lang('lang.amount')</label>
            <div class="col-12">
