 ...
 <div class="form-group row">
     <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.response_title')</label>
     <div class="col-12">
 ...
 <div class="form-group row">
     <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.category')</label>
     <div class="col-12">
 ...
 <!--message-->
 <div class="form-group row">
     <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.message')</label>
     <div class="col-12">
