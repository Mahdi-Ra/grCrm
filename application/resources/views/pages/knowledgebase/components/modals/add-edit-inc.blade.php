...
<div class="form-group row">
    <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">{{ cleanLang(__('lang.title')) }}*</label>
    <div class="col-12">
...
<div class="form-group row">
    <label for="example-month-input"
        class="col-12 control-label  col-form-label {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} required">{{ cleanLang(__('lang.category')) }}*</label>
    <div class="col-12">
...
<div class="form-group row {{ runtimeVisibilityKBArticle('text', request('category_type')) }}" id="article-text-editor-container">
    <label
        class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">{{ cleanLang(__('lang.description')) }}*</label>
    <div class="col-12">
...
<div class="form-group row {{ runtimeVisibilityKBArticle('video', request('category_type')) }}" id="article-embed-code-container">
    <label class="col-12 {{ app()->getLocale() == 'persian' ? 'text-right' : 'text-left' }} control-label col-form-label required">@lang('lang.youtube_embed_code')*</label>
    <div class="col-12">
