...
return [
    ...
    'a_project_is_required_for_billable_expenses' => "وجود پروژه الزامیست",
    'accept_amendments' => "تایید تغییرات",
    'accept_estimate_confirm' => "لطفا تایید کنید که این برآورد هزینه مورد پذیرش است",
    'accept_estimate' => "پذیرش برآورد",
    'accept' => "تایید",
    'accepted' => "تایید شد",
    'account_has_been_suspended' => "حساب کاربری شما تعلیق شده است",
    'account_not_found' => "حساب کاربری وجود ندارد",
    'account_number' => "شماره حساب",
    'account_owner' => "صاحب حساب",
    'account_status' => "وضعیت حساب",
    'account' => "حساب",
    'action_items' => "عملیات",
    'action_not_available_in_demo_mode' => "این درخواست در حالت دمو در دسترس نمیباشد",
    'action_not_completed_errors_found' => "درخواست تکمیل نشد",
    'action_only_available_on_declined_estimates' => "این درخواست فقط در بخش برآوردهای رد شده در دسترس میباشد",
    'action' => "عملیات",
    'actions_not_available' => "این اقدام در دسترس نیست",
    'actions' => "اقدامات",
    'activate' => "فعالسازی",
    'active_leads' => "فعالسازی اقدامات فروش",
    'active_projects' => "پروژه های فعال",
    'active_tasks' => "تسک های جاری",
    'active_users' => "کاربران فعال",
    'active' => "فعال",
    'activity' => "فعالیت",
    'add_a_new_category' => "افزودن دسته بندی",
    'add_a_new_item' => "افزودن محصول",
    'add_a_payment' => "افزودن پرداخت",
    ...
    'add_estimate' => "ساخت برآورد هزینه جدید",
    'add_event' => "افزودن رویداد",
    'add_expense' => "افزودن هزینه جدید",
    'add_file' => "افزودن فایل",
    'add_invoice' => "ساخت فاکتور جدید",
    'add_item' => "افزودن دیدگاه",
    'add_knowledge_base' => "ساخت مقاله جدید",
    'add_knowledgebase_category' => "افزودن دسته بندی پایگاه دانش",
    'add_lead_source' => "افزودن منبع مشتری بالقوه",
    'add_lead' => "افزودن مشتری بالقوه",
    'add_lineitem_items_first' => "ابتدا محصولات فاکتور را اضافه کنید",
    'add_milestone_category' => "افزودن دسته بندی موعد",
    'add_milestone' => "افزودن موعد جدید",
    'add_new_item' => "ایجاد یک آیتم جدید",
    'add_new_lead_status' => "افزودن وضعیت مشتری بالقوه جدید",
    'add_new_lead' => "افزودن مشتری بالقوه جدید",
    ...
    'add_selected_items' => "افزودن آیتم های منتخب",
    ...
    'add_this_inside_your_dashboard' => "این لینک را به داشبورد خود اضافه نمایید",
    'add_ticket' => "ساخت تیکت پشتیبانی جدید",
    'add_to_invoice' => "افزودن به فاکتور",
    'add_url_inside_stripe' => "این لینک را در داشبورد stripe خود وارد کنید",
    'add_user' => "ساخت کاربر جدید",
    'add' => "افزودن",
    'added_by' => "اضافه شده توسط",
    'added' => "افزوده شد",
    'additional_information' => "اطلاعات بیشتر",
    'additional_settings' => "تنظیمات بیشتر",
    'address_and_organisation_details' => "جزئیات آدرس و سازمان",
    'address' => "آدرس",
    'agree_to_terms' => "با شرایط و مقررات موافقم",
    'all_estimates' => "برآوردها",
    'all_expenses' => "هزینه ها",
    'all_invoices' => "فاکتور ها",
    'all_leads' => "مشتریان بالقوه",
    'all_projects' => "پروژه ها",
    'all_setting_permissions_when_adding_project' => "اجازه به کاربر جهت تنظیم مجوزهای مشتریان و کاربران هنگام ساخت پروژه جدید",
    'all_tasks' => "وظایف",
    'all_tickets' => "تیکت ها",
    'all_time' => "تمام زمان ها",
    'all' => "همه",
    'allow_customers_to_signup' => "اجازه به مشتری جهت ثبت نام",
    'allow_editing_of_ticket_message' => "اجازه دادن جهت ویرایش تیکت پشتیبانی",
    'allow_editing_of_ticket_subject' => "اجازه دادن جهت ویرایش موضوع تیکت پشتیبانی",
    'allow_project_managers_to_edit_milestone' => "اجازه دادن به مدیران پروژه جهت تغییر و ویرایش موعد پروژه",
    'allow_user_tags' => "اجازه دادن به کاربران جهت ساخت برچسب",
    'allow_users_to_change_backgrounds' => "اجازه به کاربران جهت تغییر پس زمینه",
    'allow_users_to_change_language' => "اجازه به کاربران جهت تغییر زیان",
    'allow_users_to_change_theme' => "اجازه به کاربران جهت تغییر تم",
    'allow_users_to_view_kb_when_not_logged_in' => "اجازه به کاربران برای مشاهده پایگاه دانش زمانی که وارد حساب کاربری نشده اند",
    'allowed_avatar_file_type' => "فرمت های مجاز تصویر پروفایل (png, jpg)",
    'allowed_file_types' => "فرمت های مجاز فایل ها",
    ...
    'app_version_could_not_be_veried' => "نسخه اپلیکیشن شما قابل تایید نیست",
    'app' => "برنامه",
    'application_backup_instructions' => "شما می توانید از طریق پنل هاست خود مانند Cpanel اقدام به پشتیبان گیری نمایید",
    'application_error' => "یک خطای سیستمی هنگام تلاش برای پردازش این درخواست رخ داده است",
    'apply_filter' => "اعمال فیلتر",
    'apply' => "اعمال",
    'april_short' => "آوریل",
    'april' => "آوریل",
    'archive_lead' => "آرشیو کردن مشتری بالقوه",
    'archive_project' => "آرشیو کردن پروژه",
    'archive_task' => "آرشیو کردن وظیفه",
    'archive' => "آرشیو کردن",
    'archived' => "آرشیو شده",
    'archives_leads' => "فعالیت فروش آرشیو شده",
    'archives_projects' => "پروژه های آرشیو شده",
    'archives_tasks' => "وظایف آرشیو شده",
    'archives' => "آرشیو ها",
    'are_you_sure_delete' => "آیا میخواید این آیتم را حذف کنید؟",
    'are_you_sure' => "مطمئنید؟",
    'Article Ordering' => "ترتیب مقالات",
    'article_not_found' => "مقاله یافت نشد",
    'article_title' => "موضوع مقاله",
    'article' => "مقاله",
    'articles' => "مقالات",
    'ascending_order' => "ترتیب صعودی",
    'assiged_manager_not_found' => "مدیر اختصاص داده شده یافت نشد",
    'assiged_user_not_found' => "کاربر اختصاص داده شده یافت نشد",
    'assign_leads' => "انتساب فعالیت فروش",
    'assign_projects' => "انتساب پروژه ها",
    'assign_tasks' => "اننساب وظایف",
    'assign_users' => "انتساب کاربران",
    'assign' => "انتساب",
    'assigned_to_me' => "اختصاص داده شده به من",
    'assigned_to_you' => "اختصاص داده شده به شما",
    'assigned_to' => "اختصاص به",
    'assigned_user_permissions' => "مجوزهای کاربر اختصاص داده شده",
    'assigned_users' => "کاربران اختصاص داده دشده",
    'assigned' => "اختصاص داده شده",
    'assigning_users_to_a_task_info' => "اختصاص وظیفه به اعضای تیم پروژه",
    'at' => "در",
    'attach_dettach' => "پیوست یا حذف",
    'attach_receipt' => "پیوست کردن رسید",
    'attach_to_project' => "پیوست به یک پروژه",
    'attach' => "پیوست کردن",
    'attachement' => "پیوست فایل",
    'attachments' => "پیوست های فایل",
    'august_short' => "آگوست",
    'august' => "آگوست",
    'available_to_all_clients' => "در دسترس برای تمام مشتریان",
    ...
    'balance' => "مانده حساب",
    'bank' => "بانک",
    'banking_details' => "جرئیات بانکی",
    'before_tax' => "قبل از مالیات",
    'best_image_dimensions' => "بهترین ابعاد تصویر",
    'bi Monthly' => "هر دو ماه یکبار",
    'bi_weekly' => "دو هفته یکبار",
    'bill_an_expense' => "فاکتور کردن هزینه",
    'bill_estimateid' => "شناسه برآورد",
    'bill_recurring_cycle_start_date' => "تاریخ شروع صورتحساب دوره ای",
    'bill_recurring_cycles_explanation_1' => "هنگام ایجاد اولین فاکتور دوره ای، بایستی تاریخ شروع دوره تکرار را هم تنظیم نمایید، پس از شروع دوره سایر تاریخ ها با طور خودکار تنظیم خواهند شد",
    'bill_recurring_cycles_explanation_2' => "فاکتورهای صادره برای روزهای خاصی از ماه مانند (29, 30, 31) در نزدیکترین روز ممکن مانند 28 صادر خواهند شد",
    'bill_recurring_cycles_explanation_3' => "اولین فاکتور صادره فاکتور اصلی(والد) می باشد، این فاکتور به محض انتشار ارسال خواهد شد",
    'bill_recurring_grace_period_info' => "تعداد روزهای باقی مانده قبل از سررسید فاکتور",
    'bill_recurring_grace_period' => "فاکتور دوره ای - دوره ی مهلت سررسید",
    'bill_recurring_period_info' => "فاکتور پس از این تعداد دوره تکرار متوقف خواهد شد، جهت ادامه بی پایان مقدار را روی 0 تنظیم نمایید",
    'bill_to' => "فاکتور برای",
    'billable_expenses' => "هزینه های قابل فاکتور شدن",
    'billable_hours_info' => "ساعاتی که هنوز برای این پروژه فاکتور نشده اند",
    'billable_hours' => "ساعات قابل فاکتور شدن",
    'billable_time' => "زمان قابل فاکتور شدن",
    'billable' => "قابل فاکتور شدن",
    'billing_address' => "آدرس صورتحساب",
    'billing_type' => "نوع صورتحساب",
    'billing' => "صورتحساب",
    'bin' => "حذف",
    'body' => "بخش بدنه HTML",
    'bulk_invoice_payments' => "پرداخت های فاکتور عمده",
    'calendar' => "تقویم",
    'call_log' => "گزارش تماس",
    'can_access_dashboard' => "می تواند به داشبورد دسترسی داشته باشد",
    'can_only_be_set_as_global' => "تنها بصورت جهانی تنظیم می شود",
    'cancel_subscription' => "لغو اشتراک",
    'cancel_upload' => "لغو بارگزاری",
    'cancel' => "لغو",
    'cancelled' => "لغو شده",
    'categories' => "دسته بندی ها",
    'Category Ordering' => "ترتیب دسته بندی ها",
    'category_already_exists' => "دسته بندی با این نام قبلا وجود دارد",
    'category_icon' => "آیکون دسته بندی",
    'category_name' => "نام دسته بندی",
    'category_not_empty' => "این دسته بندی خالی نیست، ابتدا آیتم های آنرا به دسته بندی دیگر منتقل نمایید",
    ...
    'change_milestone' => "تغییر موعد",
    'change_status' => "تغییر وضعیت",
    'change_theme' => "تغییر تم",
    'change_your_password' => "رمز عبور خود را تغییر دهید، حداقل کاراکتر ",
    'changes_will_apply_on_next_date' => "تغییرات در تاریخ تمدید فاکتور بعدی اعمال خواهند شد",
    'check_for_updates' => "بررسی بروزرسانی ها",
    'check_logs_for_details' => "برای مشاهده جزئیات بیشتر ، لطفا لاگ هارا بررسی نمایید",
    'checkbox' => "چک باکس",
    'checking_for_updates' => "درحال بررسی بروزرسانی ها",
    'checklist' => "چک لیست",
    'city' => "شهر",
    'clear_cache_confirm' => "کش سیستم شما را پاک خواهد کرد",
    'clear_cache' => "پاک کردن کش",
    'click_here' => "کلیک کنید",
    'client_already_exists' => "مشتری وجود دارد",
    'client_email_required_for_dashboard_access' => "نام و ایمیل مشتری برای تماس با دسترسی به داشبورد الزامی ست",
    'client_emails' => "ایمیل های مشتری",
    'client_files' => "فایل های مشتری",
    'client_has_not_paid_for_subsccrition' => "مشتری هنوز پرداختی انجام نداده است",
    'client_has_not_yet_accepted_the_contract' => "قرارداد هنوز توسط مشتری تایید نشده است",
    'client_id' => "شناسه مشتری",
    'client_is_required' => "وجود مشتری الزامیست",
    'client_manager_information' => "مدیریت مشتریان دسترسی کامل به تمامی پروژه ها، صورتحساب ها و سایر اطلاعات مربوط به مشتریان را خواهد داشت",
    'client_manager' => "مدیریت مشتری",
    'client_name_is_required' => "نام مشتری الزامیست",
    ...
    'client_rejected_the_contract' => "قرارداد توسط مشتری رد شد",
    'client_signature' => "امضای مشتری",
    'client_users' => "کاربران مشتری",
    'client_visibility_invalid' => "گزینه دسترسی مشتری معتبر نیست",
    'client_visibility' => "دسترسی مشتری",
    'client' => "مشتری",
    'clients' => "مشتریان",
    'clone_contract' => "کپی کردن قرارداد",
    'clone_estimate' => "کپی کردن برآورد هزینه",
    'clone_invoice' => "کپی کردن فاکتور",
    'clone_lead' => "کپی کردن مشتری بالقوه",
    'clone_project' => "کپی کردن پروژه",
    'clone_proposal' => "کپی کردن پروپوزال",
    'clone_task' => "کپی کردن وظیفه",
    'cloning_failed' => "کپی ناموفق بود، برای مشاهده جزئیات بیشتر لاگ هارا بررسی نمایید",
    'close_modal_windows_on_page_click' => "بستن پنجره پاپ آپ هنگام کلیک روی صفحه",
    'close' => "بستن",
    ...
    'color' => "رنگ",
    'comma' => "ویرگول",
    'comment_not_found' => "دیدگاه یافت نشد",
    'comment' => "دیدگاه",
    'comments' => "دیدگاه ها",
    ...
    'confirm' => "تایید",
    'confirmation_text_does_not_match' => 'متن تاییدیه تطابق ندارد',
    'contact' => "تماس",
    ...
    'contract_has_been_amended' => "این قرارداد تغییر یافته است",
    ...
    'import_leads' => "Import Sales Activity",
    ...
    'restore_leads' => "Restore Sales Activity",
