    ...
    <div id="list-page-actions">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right fx-kaban-sorting-dropdown">
                <div class="fx-kaban-sorting-dropdown-container <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>"><?php echo e(cleanLang(__('lang.sort_by'))); ?></div>
                <a class="dropdown-item js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>" id="sort_kanban_task_created" href="javascript:void(0)"
                ...
                <a class="dropdown-item js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>" id="sort_kanban_task_date_start" href="javascript:void(0)"
                ...
                <a class="dropdown-item js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>" id="sort_kanban_task_date_due" href="javascript:void(0)"
                ...
                <a class="dropdown-item js-ajax-ux-request <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>" id="sort_kanban_task_title" href="javascript:void(0)"
...
</div><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/tasks/components/misc/list-page-actions.blade.php ENDPATH**/ ?>