    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                <i class="ti-export display-inline-block <?php echo e(app()->getLocale() == 'persian' ? 'p-l-10' : 'p-r-10'); ?>"></i><?php echo e(cleanLang(__('lang.export_tasks'))); ?>
            ...
            <div class="r-panel-body p-l-35 p-r-35">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30 d-flex" for="standard_field[task_id]"><?php echo app('translator')->get('lang.id'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_title]" name="standard_field[task_title]"
                                    class="filled-in chk-col-light-blue" checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_title]"><?php echo app('translator')->get('lang.title'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_date_due]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_date_due]"><?php echo app('translator')->get('lang.due_date'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_assigned]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_assigned]"><?php echo app('translator')->get('lang.assigned'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_priority]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_priority]"><?php echo app('translator')->get('lang.priority'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_status]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_status]"><?php echo app('translator')->get('lang.status'); ?></label>
                            </div>
                        </div>
                    </div>
                    <!--billable-->
                        ...
                        <div class="form-group form-group-checkbox row <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[task_billable]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30 d-flex" for="standard_field[task_billable]"><?php echo app('translator')->get('lang.billable'); ?></label>
                            </div>
                        </div>
                    </div>
                ...
                <!--custom fields-->
                <div class="m-t-30 <?php echo e(app()->getLocale() == 'persian' ? 'text-right' : 'text-left'); ?>">
...
<!--sidebar--><?php /**PATH C:\xampp\htdocs\application\resources\views/pages/export/tasks/export.blade.php ENDPATH**/ ?>