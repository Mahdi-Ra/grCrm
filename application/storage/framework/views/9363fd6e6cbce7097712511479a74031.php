...
<body id="main-body"
    class="loggedin fix-header <?php echo e(app()->getLocale() == 'persian' ? 'rtl' : ''); ?> card-no-border fix-sidebar <?php echo e(config('settings.css_kanban')); ?> <?php echo e(runtimePreferenceLeftmenuPosition(auth()->user()->left_menu_position)); ?> <?php echo e($page['page'] ?? ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\application\resources\views/layout/wrapper.blade.php ENDPATH**/ ?>