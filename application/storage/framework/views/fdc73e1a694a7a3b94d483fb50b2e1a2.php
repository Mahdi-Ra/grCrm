<header class="topbar">
    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav <?php echo e(app()->getLocale() == 'persian' ? 'ml-auto' : 'mr-auto'); ?>">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-dark font-22 p-t-9 p-r-10 js-toggle-notifications-panel topnav-reminders-icon <?php echo e(request('user_has_due_reminder')); ?>"
                        href="javascript:void(0);" data-url="<?php echo e(url('reminders/topnav-feed?status=due')); ?>" id="topnav-reminders-icon"
...
</header><?php /**PATH C:\xampp\htdocs\application\resources\views/nav/topnav.blade.php ENDPATH**/ ?>